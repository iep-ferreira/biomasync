...
#' @examples
#' \dontrun{
#' biomastats_sync("path/to/shapefile.shp", start = 1985, end = 2020, export_folder_path = "./maps-personal-library/")
#' }

biomastats_sync <- function(shape_path = NULL,
                         start = 1985, end = 2020,
  ...
  s_utm <- sf::st_crs(s)$proj4string
    ...
    ids <- compare_shapefiles_sync(shape_path)
